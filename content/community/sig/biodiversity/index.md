---
description: "Whether you are studying species diversity or genetic variation, using whole genome sequencing or reduced representation methods, this is the place to be!"
autotoc: true
title: "Biodiversity genomics community in Galaxy"
---

<slot name="/community/sig/common_linkbox" />

Whether you are studying species diversity or genetic variation, using whole genome sequencing or reduced representation methods, this is **the place to be**!

**[Biodiversity Genomics](#biodivgenomics-community)** is a community of practice in the Galaxy community for anything regarding biodiversity genomics in Galaxy!


The biodiversity genomics community focuses on leveraging genomic technologies to study and preserve the genetic diversity of species across various ecosystems. While this community plays a crucial role in advancing our understanding of biodiversity and informing conservation efforts, its scope is limited to genomic approaches and does not encompass broader ecological or environmental studies.

# What is available?


## Tools, tutorials/trainings and workflows

Many **tools** for biodiversity genomics analysis are freely available in the ToolShed which can be installed on any Galaxy server. 

Many **tutorials** are available on the [GTN Tutorials](https://training.galaxyproject.org) for different kinds of biodiversity genomics analysis. They will guide you through the analysis step by step.

Many **workflows** for biodiversity genomics analysis are freely available on WorkFlow Hub or on a Galaxy instance. 

To keep an overview, the *[Biodiversity Genomics](#biodivgenomics-community)* community of practice maintains a **curated list** of the **many tools, trainings and workflows** available.

<iframe
  id="inlineFrameExample"
  title="Biodiversity Genomics related tools, trainings and workflows"
  width="100%"
  height="600"
  frameBorder="0"
  src="https://galaxyproject.github.io/galaxy_codex/biodiversity/">
</iframe>

If tools, trainings or workflows are missing or information is not up-to-date in the list, please help us!
Contact Saskia,[Paul](mailto:zierep@informatik.uni-freiburg.de) or [Bérénice](mailto:berenice.batut@gmail.com) about it.

<!--<img img class="img-fluid mx-auto" src="/community/sig/biodiversity/wordcloud_microgalaxy.png" alt="Biodiversity genomics tools"/>
...
# Biodiversity Genomics Community
...
Biodiversity Genomics is a [community of practice](/community/sig/#communities-of-practice) to
* **Develop** and **Sustain** biodiversity genomics analysis in Galaxy
...
Anybody interested in biodiversity genomics analysis in the Galaxy is welcome to join us! **Everybody is Welcome!**
